...
mod test {
    ...
    fn test() -> Result<(), JceError> {
        ...
        //     Some(JceElement::from(0)),
        //     Some(JceElement::from(1)),
        //     Some(JceElement::from("00000")),
        //     Some(JceElement::from(100)),
        //     Some(JceElement::from(537064989)),
        //     Some(JceElement::from("356235088634151")),
        //     Some(JceElement::from(0)),
        //     Some(JceElement::from(0)),
        //     Some(JceElement::from(0)),
        //     Some(JceElement::from(0)),
        ...
        // encode(
        //     &mut a,
        //     &JceObject::try_from([Some(JceElement::StructBegin(value))])?,
        // )?;
        // println!("{:02x?} {}", a, a.len());
