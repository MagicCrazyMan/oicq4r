...
// use crate::{client::Client, core::tea, error::Error};
...
//             let head = protobuf::encode(&DecodeProtobufObject::from([
//                 (
//                     1,
//                     DecodeProtobufElement::Object(DecodeProtobufObject::from([
//                         (1, DecodeProtobufElement::from(1)),
//                         (2, DecodeProtobufElement::from(me.uin.to_string())),
//                         (3, DecodeProtobufElement::from("PicUp.DataUp")),
//                         (4, DecodeProtobufElement::from(*me.seq)),
//                         (6, DecodeProtobufElement::from(*me.subid)),
//                         (7, DecodeProtobufElement::from(4096)),
//                         (8, DecodeProtobufElement::from(*me.command_id as u8)),
//                         (10, DecodeProtobufElement::from(2052)),
//                     ])),
//                 ),
//                 (
//                     2,
//                     DecodeProtobufElement::Object(DecodeProtobufObject::from([
//                         (2, DecodeProtobufElement::from(*me.total)),
//                         (3, DecodeProtobufElement::from(*me.transformed)),
//                         (4, DecodeProtobufElement::from(filled.len() as isize)),
//                         (6, DecodeProtobufElement::from(&me.ticket[..])),
//                         (8, DecodeProtobufElement::from(md5_filled)),
//                         (9, DecodeProtobufElement::from(&me.md5[..])),
//                     ])),
//                 ),
//                 (3, DecodeProtobufElement::from(&me.ext[..])),
//             ]))
...
//                         break;
//                     } else {
//                         let mut r2: DecodeProtobufObject = rsp.try_remove(&2)?.try_into()?;
